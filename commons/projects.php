  <section id="services" class="projects-section bg-light">
    <div class="container">
      ...
      <div class="row justify-content-center no-gutters mb-5 mb-lg-0">
        <div class="col-lg-6">
          <img class="img-fluid" src="img/unonovosette.jpg" alt="Logo UNONOVESETTE" aria-describedby="unonovosetteText">
        </div>
        <div class="col-lg-6">
          <div class="bg-black text-center h-100 project">
            <div class="d-flex h-100">
              <div class="project-text w-100 my-auto text-center text-lg-left">
                ...
                <p class="mb-0 text-white-50" id="unonovosetteText">Combinaison de la technologie LED haut de gamme avec le design de la qualité italienne</p>
                <hr class="d-none d-lg-block mb-0 ml-0">
